    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                ...
                <x-responsive-nav-link
                    :active="request()->routeIs('applications.index') && request()->query('type') == 'official_letter_request'"
                    href="{{ route('applications.index',[
    'type'=>'official_letter_request'
]) }}">
                    {{ __('Official Letter Request') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link

                    :active="request()->routeIs('applications.index') && request()->query('type') == 'internship_application'"
                    href="{{ route('applications.index',[
    'type'=>'internship_application'
]) }}">
                    {{ __('Internship Application') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link
